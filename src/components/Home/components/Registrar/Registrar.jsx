...
function Registrar() {
  ...
  return (
    ...
    <Form className="login-form"
      ...
      <Form.Row>
        <Form.Group as={Col} controlId="formGridPassword">
          ...
          <Form.Control onChange={event => setConfirmPassword(event.target.value)}
            name="confirmaSenha" value={confirmPassword} type="password" placeholder="Informe a senha..." />
        </Form.Group>
      </Form.Row>
      ...
      <Button className="btn-lg btn-block" variant="link" to="/login" onClick={() => history.push('/login')}>Login</Button>
